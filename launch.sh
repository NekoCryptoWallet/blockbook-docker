...
while true; do
    ...
    exec ./blockbook -blockchaincfg=$CFG_FILE -datadir=/blockbook/db -resyncindexperiod=60017 -resyncmempoolperiod=60017 -resyncmempoolperiod=60017 -workers=${WORKERS:-1} -public=:${BLOCKBOOK_PORT:-9141} -logtostderr "$@"
